 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.kairos.tuto.model.kairosTuto.impl.OutputPortImpl#getConnector <em>Connector</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputPortImpl extends PortImpl implements OutputPort {
	...
	protected EClass eStaticClass() {
		return KairosTutoPackage.Literals.OUTPUT_PORT;
	}
		...
		if (connector != null && connector.eIsProxy()) {
			...
			if (connector != oldConnector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KairosTutoPackage.OUTPUT_PORT__CONNECTOR,
	...
	public NotificationChain basicSetConnector(Connector newConnector, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					KairosTutoPackage.OUTPUT_PORT__CONNECTOR, oldConnector, newConnector);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setConnector(Connector newConnector) {
		if (newConnector != connector) {
			...
			if (connector != null)
				msgs = ((InternalEObject) connector).eInverseRemove(this, KairosTutoPackage.CONNECTOR__OUTPUTPORT,
						Connector.class, msgs);
			if (newConnector != null)
				msgs = ((InternalEObject) newConnector).eInverseAdd(this, KairosTutoPackage.CONNECTOR__OUTPUTPORT,
						Connector.class, msgs);
			msgs = basicSetConnector(newConnector, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KairosTutoPackage.OUTPUT_PORT__CONNECTOR,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case KairosTutoPackage.OUTPUT_PORT__CONNECTOR:
			if (connector != null)
				msgs = ((InternalEObject) connector).eInverseRemove(this, KairosTutoPackage.CONNECTOR__OUTPUTPORT,
						Connector.class, msgs);
