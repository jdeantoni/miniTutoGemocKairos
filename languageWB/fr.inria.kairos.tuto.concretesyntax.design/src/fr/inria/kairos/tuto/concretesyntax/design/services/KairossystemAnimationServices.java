package fr.inria.kairos.tuto.concretesyntax.design.services;
...
public class KairossystemAnimationServices extends AbstractGemocDebuggerServices {
	...
	protected List<StringCouple> getRepresentationRefreshList() {
		...
		res.add(new StringCouple("KairosSystem", "Animation"));
